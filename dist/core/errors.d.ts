...
export type PrettyAuiErrorCode = "AUTO_NEGOTIATION_REQUIRES_FACTORY" | "AUTHENTICATION_REQUIRED" | "CAPABILITY_REQUIRED" | "CONNECTION_CLOSED" | "CONTEXT_FAILED" | "INITIALIZE_REJECTED" | "INVALID_CONFIGURATION" | "INVALID_WIRE_FRAME" | "METHOD_NOT_AVAILABLE" | "PROTOCOL_VERSION_MISMATCH" | "PROTOCOL_VIOLATION" | "SESSION_BUSY" | "SESSION_NOT_READY" | "TURN_INTERRUPTED" | "UNSUPPORTED_PROTOCOL";
