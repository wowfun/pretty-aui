...
import type { ChatController, ChatOptions, ChatToolCall } from "../core/types.js";
import type { ChatColorScheme, ChatLabels, ChatSurface } from "../presentation.js";
export { defaultLabels } from "../presentation.js";
export type { ChatColorScheme, ChatLabels, ChatSurface, } from "../presentation.js";
/** Renders the body of one normalized tool activity. Return `undefined` to use the built-in body. */
export type ToolActivityRenderer = (tool: ChatToolCall) => ReactNode | undefined;
...
export type ChatRootProps = ChatPresentationProps & ChatOwnershipProps & {
