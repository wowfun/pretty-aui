...
export interface AcpConnector {
  open(
    options: AcpConnectorOpenOptions,
  ): Promise<AcpWireStream> | AcpWireStream;
}
...
export type ChatActivity =
  ChatMessage | ChatToolCall | ChatPlan | ChatTerminal | UnsupportedActivity;
...
export type ChatEvent =
  | { readonly type: "connected"; readonly protocolVersion: AcpProtocolVersion }
  | { readonly type: "session_changed"; readonly sessionId: string }
  | { readonly type: "turn_started"; readonly turnId: string }
  | {
  ...
  | { readonly type: "error"; readonly error: ChatErrorState };
